...
if(NOT CMAKE_ASM${ASM_DIALECT}_COMPILER_ID)
  ...
  elseif("x${CMAKE_ASM${ASM_DIALECT}_COMPILER_ID}" STREQUAL "xRENESAS")
    ...
    if("${CMAKE_ASM${ASM_DIALECT}_COMPILER_ID_OUTPUT}" MATCHES "(RX|RL78|RH850) Family Assembler V0*([0-9]+)\\.0*([0-9]+)\\.0*([0-9]+)")
...
if(CMAKE_ASM${ASM_DIALECT}_COMPILER_ID)
  ...
  if(CMAKE_ASM${ASM_DIALECT}_COMPILER_ARCHITECTURE_ID AND "x${CMAKE_ASM${ASM_DIALECT}_COMPILER_ID}" MATCHES "xIAR|xRENESAS")
