...
macro(__compiler_renesas lang)
  ...
  # it is also possible that CMake uses reponse files always.
  ...
  if(${lang} STREQUAL "C" OR ${lang} STREQUAL "CXX")
    ...
    # Therefore the following flags are used for CC-{RX, RL, RH}.
    #                   CC-RX                                    CC-{RL, RH}
  ...
  #set_property(GLOBAL PROPERTY TARGET_SUPPORTS_SHARED_LIBS FALSE) # This is done in Modules/Platform/Generic.cmake
