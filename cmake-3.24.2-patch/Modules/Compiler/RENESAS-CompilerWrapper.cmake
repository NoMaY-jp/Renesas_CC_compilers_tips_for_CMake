...
if(NOT target_opt)
  ...
  if(src_name MATCHES "CMakeTmp(/|\\\\)testCCompiler\\.c$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "Modules(/|\\\\)CMakeCCompilerABI\\.c$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "CMakeFiles(/|\\\\)feature_tests\\.c$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "CMakeTmp(/|\\\\)testCXXCompiler\\.cpp$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "Modules(/|\\\\)CMakeCXXCompilerABI\\.cpp$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "CMakeFiles(/|\\\\)feature_tests\\.cxx$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang}) # FIXME: Also -cpp option?
    #message("DEBUG: src_name = ${src_name}")
  endif()
endif()
