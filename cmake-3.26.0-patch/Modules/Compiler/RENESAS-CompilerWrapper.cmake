...
if(NOT target_opt)
  ...
  if(src_name MATCHES "CMakeScratch(/|\\\\)(testCCompiler\\.c|testCXXCompiler\\.cpp)$") # FIXME: Is this file still here?
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "Modules(/|\\\\)(CMakeCCompilerABI\\.c|CMakeCXXCompilerABI\\.cpp)$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  elseif(src_name MATCHES "CMakeScratch(/|\\\\)[^/\\\\]+(/|\\\\)feature_tests\\.(c|cxx)$")
    list(PREPEND cmd_args_list ${try_compile_compiler_target_arg} ${try_compile_compiler_msg_lang})
    #message("DEBUG: src_name = ${src_name}")
  endif()
endif()
