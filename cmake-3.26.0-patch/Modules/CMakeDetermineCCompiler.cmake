...
include(CMakeDetermineCompiler) ##### temporary modification # original: ${CMAKE_ROOT}/Modules/CMakeDetermineCompiler.cmake
...
elseif("${CMAKE_GENERATOR}" MATCHES "Xcode")
  ...
  set(CMAKE_C_COMPILER_ID_TEST_FLAGS
    ...
    # Renesas CC-RX needs -isa flag. But the flag may have been set as arg1.
    # In the case, the former -isa flag on the command line is ignored.
    "-output=obj -isa=rxv1"

    # Renesas CC-RL needs -cpu flag. But the flag may have been set as arg1.
    # In the case, simple -c flag of the first entry of this list is enough.
    "-c -cpu=S2"
    )
endif()
...
if(NOT CMAKE_C_COMPILER_ID_RUN)
  ...
  file(READ ${CMAKE_MODULE_PATH}/CMakePlatformId.h.in #### temporary modification # original: ${CMAKE_ROOT}/Modules/CMakePlatformId.h.in
  ...
  include(CMakeDetermineCompilerId) #### temporary modification # original: ${CMAKE_ROOT}/Modules/CMakeDetermineCompilerId.cmake
